...
const Header = () => {
  return (
    <div className="w-full flex fixed text-white justify-between px-10 py-3 bg-gradient-to-b from-[#75000067] to-transparent z-10">
      <span
        onClick={() => window.scrollTo(top)}
        className="text-[1.7vw] font-extrabold font-poppins group cursor-pointer"
      >
